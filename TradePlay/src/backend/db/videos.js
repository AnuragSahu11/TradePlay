...
export const videos = [
  {
    _id: "Uxllqa-2pAs",
    title:
      "CRYPTO TRADING TREND LINES - HOW TO USE TREND LINES FOR TRADING CRYPTOCURRENCY",
    description:
      "In this exclusive edition of Sniper's Master Class we teach you how to become a professional Crypto trader using trend lines! This class focuses on what trend lines are and how to draw them effortlessly to become the best Bitcoin and Altcoin trader that you can be, and maximise your Crypto portfolio returns DAILY!",
    creator: "Crypto Banter",
    videoLink:
      "https://www.youtube.com/embed/Uxllqa-2pAs?list=PLmOv2_vzOoGcTirwpJoyhGrYRnv1CRyIa",
    views: 200,
    category: "crypto",
  },
  {
    _id: "x2LvOCFbJiI",
    title:
      "CRYPTO TRADING - HOW TO FIND SUPPORT AND RESISTANCE FOR TRADING CRYPTOCURRENCY",
    creator: " Crypto Banter",
    videoLink:
      "https://www.youtube.com/embed/x2LvOCFbJiI?list=PLmOv2_vzOoGcTirwpJoyhGrYRnv1CRyIa",
    description:
      "Crypto Trading With Support and Resistance - In this exclusive edition of Sniper's Master Class, we teach you how to become a professional Crypto trader using Support & Resistance lines! This class focuses on what support/resistance lines are, how to draw them effortlessly to become the best Bitcoin and Altcoin trader that you can be, and maximize your Crypto portfolio returns DAILY!",
    views: 150,
    category: "crypto",
  },
  {
    _id: "YX-RZKjGV-M",
    title: "CRYPTO TRADING - HOW TO TRADE CRYPTOCURRENCY USING MOVING AVERAGES",
    videoLink:
  ...
  },
  {
    _id: "zSGCtoO4VJU",
    title:
      "CRYPTO TRADING - HOW TO MASTER FIBONACCI RETRACEMENT TOOLS TO TRADE CRYPTOCURRENCY",
    creator: "Crypto Banter",
    videoLink:
  ...
  {
    _id: "g1nytORNq0E",
    title: "Stock Market Terminology Every Trader Must Know",
    creator: "Rayner Teo",
    videoLink:
      "https://www.youtube.com/embed/g1nytORNq0E?list=PLT6_Bt_TKitIUCEsI-3SGCrVHCy0g_5jd",
    description:
      "In this lesson, you'll discover the essential stock market terminology that every trader must know.",
    views: 300,
    category: "stock",
  },
  {
